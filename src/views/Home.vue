        ...
        <section id="work" class="ftco-section">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-4 heading-section text-center ftco-animate pb-5 fadeInUp ftco-animated">
                ...
                <div class="row no-gutters">
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-1.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-2.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-3.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-4.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-6.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-7.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-8.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-9.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-10.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-11.jpg);">
                    ...
                    <div class="col-md-4 ftco-animate fadeInUp ftco-animated">
                        <div class="model img d-flex align-items-end"
                            style="background-image: url(images/model-12.jpg);">
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-4 heading-section text-center ftco-animate fadeInUp ftco-animated">
                        ...
                        <p class="about-decription">A small river named Duden flows by their place and supplies it with the necessary regelialia.
                            It is a paradisematic country.</p>
                    </div>
                </div>
                    ...
                    <div class="col-md-3 d-flex ftco-animate fadeInUp ftco-animated">
                        <div class="align-self-stretch box text-center p-4">
                            ...
                            <div>
                                ...
                                <p class="about-decription">198 West 21th Street, Suite 721 New York NY 10016</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 d-flex ftco-animate fadeInUp ftco-animated">
                        <div class="align-self-stretch box text-center p-4">
                            ...
                            <div>
                                ...
                                <p><a class="about-decription" href="tel://1234567920">+ 1235 2355 98</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 d-flex ftco-animate fadeInUp ftco-animated">
                        <div class="align-self-stretch box text-center p-4">
                            ...
                            <div>
                                ...
                                <p><a class="about-decription" href="mailto:info@yoursite.com">info@yoursite.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 d-flex ftco-animate fadeInUp ftco-animated">
                        <div class="align-self-stretch box text-center p-4">
                            ...
                            <div>
                                ...
                                <p><a class="about-decription" href="#">yoursite.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
