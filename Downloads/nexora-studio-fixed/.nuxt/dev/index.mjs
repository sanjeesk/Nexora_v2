...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
...
import { ErrorParser } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/nostics/dist/index.mjs';
...
import { walkResolver } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/snajeekumar/Downloads/nexora-studio-fixed/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/snajeekumar/Downloads/nexora-studio-fixed/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/snajeekumar/Downloads/nexora-studio-fixed","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/snajeekumar/Downloads/nexora-studio-fixed/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/snajeekumar/Downloads/nexora-studio-fixed/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/snajeekumar/Downloads/nexora-studio-fixed/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/snajeekumar/Downloads/nexora-studio-fixed/.data/kv"}));
...
const _HoqHlJ8zG4TXJbEbg9IwfdwE88jIeFNTnxbTEy4xBY = (function(nitro) {
...
const rootDir = "/Users/snajeekumar/Downloads/nexora-studio-fixed";
...
const plugins = [
  _HoqHlJ8zG4TXJbEbg9IwfdwE88jIeFNTnxbTEy4xBY,
...
const _9D3wxR = eventHandler((event) => {
...
const _77ja7b = defineCachedEventHandler(async (event) => {
...
const _lazy_Vus9zi = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _9D3wxR, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Vus9zi, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _77ja7b, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Vus9zi, lazy: true, middleware: false, method: undefined }
];
