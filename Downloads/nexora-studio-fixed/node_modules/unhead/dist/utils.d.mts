import { HeadTag, MetaFlat, UnheadMeta, TemplateParams } from './types.mjs';
import { Unhead } from './client.mjs';
import { PropResolver } from './types.mjs';
import 'hookable';
...
declare function hasOwn(object: object, key: PropertyKey): boolean;
...
declare function unpackMeta<T extends MetaFlat>(input: T): UnheadMeta[];
